...
export default function SucursalesModal({ isOpen, onClose }: SucursalesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden animate-in zoom-in-95 duration-300">
        {/* Header */}
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-100px)]">
          ...
          <div className="p-6 bg-gradient-to-br from-cyan-50 via-blue-50 to-teal-50">
            <div className="grid lg:grid-cols-2 gap-6">
              {/* Sucursal 1 */}
              <div className="bg-white rounded-2xl overflow-hidden shadow-xl border-4 border-cyan-100 hover:border-cyan-300 transition-all duration-300">
              ...
              {/* Sucursal 2 */}
              <div className="bg-white rounded-2xl overflow-hidden shadow-xl border-4 border-teal-100 hover:border-teal-300 transition-all duration-300">
